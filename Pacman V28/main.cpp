...
#define Pac_wack11 161,5,11,11
    ...
    texture15.loadFromFile("Assets/Settings_1.png");

    sf::Texture texture16;
    texture16.loadFromFile("Assets/Settings_2.png");

    sf::Texture texture17;
    texture17.loadFromFile("Assets/Return_1.png");

    sf::Texture texture18;
    texture18.loadFromFile("Assets/Return_2.png");

    sf::Texture texture19;
    texture19.loadFromFile("Assets/Help_1.png");

    sf::Texture texture20;
    texture20.loadFromFile("Assets/Help_2.png");

    sf::Texture texture21;
    texture21.loadFromFile("Assets/Yes_1.png");

    sf::Texture texture22;
    texture22.loadFromFile("Assets/No_1.png");
    ...
    sound2.loadFromFile("Assets/Audio/Wii_Menu.wav");
        ...
        while (window.pollEvent(event)) {
            ...
            if(isSpriteHover(Setting.getGlobalBounds(), sf::Vector2f(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y)) == true) {
                ...
                if(event.type == sf::Event::MouseButtonReleased &&  event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    Settings_text_sprite.setPosition(100, 200);

                    for(int i = 0; i<3; i++) {
                        YorN[i].setPosition(400,i*90+200);
                    }
            ...
            if(isSpriteHover3(Help.getGlobalBounds(), sf::Vector2f(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y)) == true) {
                ...
                if(event.type == sf::Event::MouseButtonReleased &&  event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    StartImage.setPosition(1000, 1000);
                    PreStart.setPosition(1000,1000);
                    Help_text_sprite.setPosition(0, 200);
