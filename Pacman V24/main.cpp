...
void Teleport(sf::Sprite &PacMan, sf::Sprite &OrangeGhost, sf::Sprite &RedGhost, sf::Sprite &PinkGhost, sf::Sprite &BlueGhost) {
...
// teleport
        ...
        Teleport(PacMan, OrangeGhost, RedGhost, PinkGhost, BlueGhost);
