...
////////
    ...
    sf::Text scoreDis("Score: "+scoreShow, font);
    ...
    sf::Text HsDis("HS: "+HSString, font);
...
//////////eye code
        ...
        if(Deadmove.red == true) {
            ...
            if((RedGhost.getPosition().x > 265 && RedGhost.getPosition().x < 270) && (RedGhost.getPosition().y > 265 && RedGhost.getPosition().y < 270)) {
        ...
        if(Deadmove.orange == true) {
            ...
            if(OrangeGhost.getPosition().x > 267)
                OrangeX = -1;
            ...
            if((OrangeGhost.getPosition().x > 265 && OrangeGhost.getPosition().x < 270) && (OrangeGhost.getPosition().y > 265 && OrangeGhost.getPosition().y < 270)) {
        ...
        if(Deadmove.pink == true) {
            ...
            if(PinkGhost.getPosition().x > 267)
                PinkX = -1;
            ...
            if((PinkGhost.getPosition().x > 265 && PinkGhost.getPosition().x < 270) && (PinkGhost.getPosition().y > 265 && PinkGhost.getPosition().y < 270)) {
